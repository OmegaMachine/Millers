...
Generate_DailyLog:
if(ActiveJob){
    Out("Generating daily log from template [template_DL.xlsm]")
LastDailyLog:=new File(Push_TemplateToFile(A_ScriptDir . "\templates\template_DL.xlsm",A_ScriptDir . "\Conversions\DailyLogs\DailyLog (" . ActiveJobFile.FileName . ").xlsm"))
if(!LastDailyLog){
Out("Conversion Failed")
}else{
